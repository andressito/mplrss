 ...
 */
public class AllItemFragment extends ListFragment implements LoaderManager.LoaderCallbacks<Cursor> {
...
*/
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        return new CursorLoader(getActivity(),uri, new String[]{"title","description"}, null,null,null);
    }
    ...
    public interface OnFragmentInteractionListener {
        ...
        void onAllItemSelection(String title);
    }
    ...
    public void onListItemClick(ListView l, View v, int position, long id){
        ...
        mListener.onAllItemSelection(title);
    }
}
